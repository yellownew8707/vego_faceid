...
define KernelPackage/sunxi-vfe
  ...
  FILES+=$(LINUX_DIR)/drivers/media/video/sunxi-vfe/device/ov2718_xc7023.ko
  FILES+=$(LINUX_DIR)/drivers/media/video/sunxi-vfe/vfe_v4l2.ko
  AUTOLOAD:=$(call AutoLoad,30,videobuf-core videobuf-dma-contig cci vfe_os vfe_subdev ov2718_xc7023 vfe_v4l2)
endef
