...
MG_EXPORT void GUIAPI BeginBatchPaint(unsigned int cnt);

MG_EXPORT void GUIAPI EndBatchPaint(void);

MG_EXPORT void GUIAPI HideUILayer(void);

MG_EXPORT void GUIAPI ShowUILayer(void);
