...
#
# Returns the list of all Products.mk files.
# $(call ) isn't necessary.
#
define _find-vego-products-files
$(shell test -d target && find target -maxdepth 4 -name Products.mk)
endef
...
$(call get-product-makefiles,$(_find-vego-products-files))
endef
