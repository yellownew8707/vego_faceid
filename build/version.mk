...
ifeq "" "$(TARGET_VERSION_DIST)"
  TARGET_VERSION_DIST := vego.$(USER).$(shell date +%Y%m%d.%H%M%S)
endif

ifeq "" "$(TARGET_VERSION_MANUFACTURER)"
  TARGET_VERSION_MANUFACTURER := vyagoo
endif

ifeq "" "$(TARGET_VERSION_MANUFACTURER_URL)"
  TARGET_VERSION_MANUFACTURER_URL := www.vyagoo.com
endif

ifeq "" "$(TARGET_VERSION_REPO)"
  TARGET_VERSION_REPO := http://github.com/openwrt
endif
