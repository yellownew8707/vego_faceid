...
ifeq ($(DUMP),)
  PLATFORM_DIR:=$(TOPDIR)/target/vego/$(BOARD)
  PLATFORM_COMMON_DIR:=$(TOPDIR)/target/vego/$(shell echo -n $(BOARD) | sed -e 's/-.*//g')-common
...
GENERIC_PLATFORM_DIR := $(TOPDIR)/target/vego/generic
